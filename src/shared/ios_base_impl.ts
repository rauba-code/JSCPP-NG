...
export function defineOstream(rt: CRuntime, name: string, moreMembers: MemberObject[]) {
    ...
    },
    {
        ...
        default(rt: CRuntime, l: ios_base.OStreamVariable, r: ArithmeticVariable): ios_base.OStreamVariable {
    ...
    },
    {
        ...
        default(_rt: CRuntime, _this: ios_base.OStreamVariable) {
    ...
    },
    {
        op: "o(_bool)",
        type: `FUNCTION BOOL ( LREF CLASS ${name} < > )`,
        default(_rt: CRuntime, _this: ios_base.OStreamVariable): ArithmeticVariable {
            const failbit = _this.v.members.failbit.v.value;
            const badbit = _this.v.members.badbit.v.value;
