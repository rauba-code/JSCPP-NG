...
export = {
    load(rt: CRuntime) {
        ...
        rt.defineStruct("{global}", "string", [
            ...
            const lptr = variables.asInitIndexPointerOfElem(x.v.members._ptr, variables.uninitArithmeticNum("I8", null));
            if (lptr) {
        ...
        function cmpOverloads(op: OpSignature, fn: (strcmpRetv: number) => boolean): common.OpHandler[] {
            return [{
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable, r: StringVariable): InitArithmeticNumVariable {
                    ...
                    return variables.arithmeticNum("BOOL", fn(strncmp(rt, lptr, rptr, l.v.members._size.v.value)) ? 1 : 0, null);
                }
            },
            {
                op,
        ...
        common.regOps(rt, [
            ...
            ...cmpOverloads("o(_<_)", (x) => x < 0),
            {
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable, _idx: ArithmeticNumVariable): ArithmeticNumVariable {
                    ...
                    const lptr = variables.asInitIndexPointerOfElem(l.v.members._ptr, variables.uninitArithmeticNum("I8", null)) ?? rt.raiseException("Variable is not an initialised index pointer");
                    return variables.arrayMember(lptr.v.pointee, lptr.v.index + idx) as ArithmeticNumVariable;
                }
            },
            {
                op: "o(_+_)",
            ...
            },
            {
                ...
                *default(rt: CRuntime, _templateTypes: [], l: StringVariable, r: ArithmeticNumVariable): Gen<StringVariable> {
                    ...
                    memory.values.push(variables.arithmeticNum("I8", rt.arithmeticNumValue(r), { array: memory, index: 0 }).v);
                    memory.values.push(variables.arithmeticNum("I8", 0, { array: memory, index: 0 }).v);
            ...
            },
            {
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable, r: ArithmeticNumVariable): StringVariable {
                    ...
                    (lptr.v.pointee.values[lptr.v.pointee.values.length - 1] as InitArithmeticNumValue).value = rt.arithmeticNumValue(r);
                    lptr.v.pointee.values.push(variables.arithmeticNum("I8", 0, { array: lptr.v.pointee, index: lptr.v.pointee.values.length }).v);
        ...
        function strConcat(rt: CRuntime, l: StringVariable, _r: PointerVariable<ArithmeticNumVariable>, rsz: number): { size: number, ptr: InitIndexPointerVariable<ArithmeticNumVariable> } {
            ...
            const memory = variables.arrayMemory<ArithmeticNumVariable>(variables.arithmeticNumType("I8"), []);
            for (let i = 0; i < lsz; i++) {
                const chr = rt.arithmeticNumValue2(variables.arrayMember(lptr.v.pointee, lptr.v.index + i));
                memory.values.push(variables.arithmeticNum("I8", chr, { array: memory, index: memory.values.length }).v);
            }
            for (let i = 0; i < rsz; i++) {
                const chr = rt.arithmeticNumValue2(variables.arrayMember(rptr.v.pointee, rptr.v.index + i));
                memory.values.push(variables.arithmeticNum("I8", chr, { array: memory, index: memory.values.length }).v);
            }
        ...
        common.regMemberFuncs(rt, "string", [
            {
                ...
                default(_rt: CRuntime, _templateTypes: [], l: StringVariable): InitArithmeticNumVariable {
                    return variables.arithmeticNum("BOOL", l.v.members._size.v.value === 0 ? 1 : 0, null);
                }
            },
            {
                op: "begin",
            ...
            },
            {
                ...
                *default(rt: CRuntime, _templateTypes: [], l: StringVariable, pos: InitArithmeticNumVariable, count: InitArithmeticNumVariable, r: StringVariable): Gen<StringVariable> {
                    ...
                    l.v.members._ptr = variables.indexPointer(variables.arrayMemory<ArithmeticNumVariable>(variables.arithmeticNumType("I8"), []), 0, false, "SELF");
            ...
            },
            {
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable): ArithmeticNumVariable {
                    ...
                    const lptr = variables.asInitIndexPointerOfElem(l.v.members._ptr, variables.uninitArithmeticNum("I8", null)) ?? rt.raiseException("Variable is not an initialised index pointer");
                    return variables.arrayMember(lptr.v.pointee, lptr.v.index) as ArithmeticNumVariable;
                }
            },
            {
                op: "pop_back",
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable): "VOID" {
                    ...
                    const nullChar = variables.arithmeticNum("I8", 0, { array: lptr.v.pointee, index: lptr.v.index + newSize });
            ...
            },
            {
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable): ArithmeticNumVariable {
                    ...
                    const lptr = variables.asInitIndexPointerOfElem(l.v.members._ptr, variables.uninitArithmeticNum("I8", null)) ?? rt.raiseException("Variable is not an initialised index pointer");
                    return variables.arrayMember(lptr.v.pointee, lptr.v.index + size - 1) as ArithmeticNumVariable;
                }
            },
            {
                op: "data",
                ...
                default(rt: CRuntime, _templateTypes: [], l: StringVariable): InitPointerVariable<ArithmeticNumVariable> {
                    ...
                    return variables.asInitIndexPointerOfElem(l.v.members._ptr, variables.uninitArithmeticNum("I8", null)) ?? rt.raiseException("Variable is not an initialised index pointer");
                }
            },
            {
                op: "c_str",
            ...
            },
            {
                ...
                default(_rt: CRuntime, _templateTypes: [], l: StringVariable): InitArithmeticNumVariable {
                    return variables.arithmeticNum("I32", l.v.members._size.v.value, null);
                }
            },
            {
                op: "size",
