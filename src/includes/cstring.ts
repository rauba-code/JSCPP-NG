    ...
    load(rt: CRuntime) {
        ...
        common.regGlobalFuncs(rt, [{
            ...
            default(rt: CRuntime, _templateTypes: [], _a: PointerVariable<ArithmeticNumVariable>, _b: PointerVariable<ArithmeticNumVariable>): InitIndexPointerVariable<ArithmeticNumVariable> {
                ...
                let bv : number;
                for (let bi = 0; (bv = rt.arithmeticValue(variables.arrayMember(b.pointee, b.index + bi)) as number) !== 0; bi++) {
                    variables.arithmeticNumValueAssign(rt, (rt.unbound(variables.arrayMember(a.pointee, a.index + ai)) as ArithmeticNumVariable), bv);
                    ai++;
                }
                variables.arithmeticNumValueAssign(rt, (rt.unbound(variables.arrayMember(a.pointee, a.index + ai)) as ArithmeticNumVariable), 0);
                return b;
            }
        }, {
            type: "FUNCTION PTR I8 ( PTR I8 PTR I8 )",
            ...
            default(rt: CRuntime, _templateTypes: [], _a: PointerVariable<ArithmeticNumVariable>, _b: PointerVariable<ArithmeticNumVariable>): InitIndexPointerVariable<ArithmeticNumVariable> {
                ...
                for (i = 0; (bv = rt.arithmeticValue(variables.arrayMember(b.pointee, b.index + i)) as number) !== 0; i++) {
                    variables.arithmeticNumValueAssign(rt, (rt.unbound(variables.arrayMember(a.pointee, a.index + i)) as ArithmeticNumVariable), bv);
                }
                variables.arithmeticNumValueAssign(rt, (rt.unbound(variables.arrayMember(a.pointee, a.index + i)) as ArithmeticNumVariable), 0);
                return variables.indexPointer(a.pointee, a.index + i, false, null);
            }
        }]);
